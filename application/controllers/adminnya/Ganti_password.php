...
class Ganti_password extends My_Controller {
    ...
    public function update() {
        ...
        if ($this->form_validation->run() === FALSE) {
            ...
            if ($this->Adminauth_model->verify_password($user_id, $current_password)) {
                if ($this->Adminauth_model->update_password($user_id, $new_password)) {
            ...
            redirect('adminnya/ganti_password/');
        }
    }
