            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">                        
                            <form action="<?php echo site_url('adminnya/subkategori/add'); ?>" method="POST">
                                <div class="form-group">
                                    <label for="subkategori">Nama Sub Kategori</label>
                                    <input type="text" class="form-control" id="subkategori" name="subkategori" placeholder="Masukkan nama sub kategori" required>
                                </div>
                                <div class="form-group">
