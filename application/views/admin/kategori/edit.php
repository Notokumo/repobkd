            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">                        
                            <form action="<?php echo site_url('adminnya/kategori/edit/' . $kategori->id); ?>" method="POST">
                                <div class="form-group">
                                    <label for="kategori">Nama Kategori</label>
                                    <input type="text" class="form-control" id="kategori" name="kategori" value="<?php echo set_value('kategori', $kategori->nama_katbkd); ?>" required>
                                </div>
