...
<body>
    <div class="container">
        ...
        <?php endif; ?>
        <?php echo form_open_multipart('adminnya/bkd/update/' . $bkd->id); ?>
        <div class="form-group">
            <label for="dosen_id">Dosen ID</label>
            <input type="text" class="form-control" id="dosen_id" name="dosen_id" value="<?php echo $bkd->dosen_id; ?>" required>
        </div>
        <div class="form-group">
            ...
            <select class="form-control" id="tahun_akademik_id" name="tahun_akademik_id" required>
                <?php foreach ($tahun_akademik as $tahun): ?>
                    <option value="<?php echo $tahun->id; ?>" <?php echo ($tahun->id == $bkd->tahun_akademik_id) ? 'selected' : ''; ?>><?php echo $tahun->tahun; ?></option>
                <?php endforeach; ?>
            </select>
        </div>
        <div class="form-group">
            ...
            <select class="form-control" id="kategori_id" name="kategori_id" required>
                ...
                <?php foreach ($kategori as $kat): ?>
                    <option value="<?php echo $kat->id; ?>" <?php echo ($kat->id == $bkd->kategori_id) ? 'selected' : ''; ?>><?php echo $kat->nama; ?></option>
                <?php endforeach; ?>
            </select>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="nama_bkd" name="nama_bkd" value="<?php echo $bkd->nama_bkd; ?>" required>
        </div>
        <div class="form-group">
    ...
    <script>
        $(document).ready(function() {
            ...
            // Set subkategori yang sudah ada
            $('#kategori_id').val('<?php echo $bkd->kategori_id; ?>').change();
        });
    </script>
</body>
</html>
