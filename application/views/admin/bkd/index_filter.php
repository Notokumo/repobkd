                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <!-- Filters -->
                                <form action="<?php echo site_url('adminnya/bkd/filter'); ?>" method="GET">
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-control" id="tahun_akademik_id" name="tahun_akademik_id" required>
                                            <option value="all" <?php if ($get_thn == 'all') echo 'selected'; ?>>Semua Tahun Akademik</option>
                                            <?php foreach ($tahun_akademik as $tahun): ?>
                                                <option value="<?php echo $tahun->id; ?>"<?php if ($tahun->id == $get_thn) echo 'selected'; ?>><?php echo $tahun->nama_thnakademik; ?><?php if ($tahun->aktif == 1) echo ' - AKTIF SAAT INI'; ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                                    <div class="col-md-6 form-group">
                                        ...
                                        <select class="form-control" id="dosen" name="dosen" required>
                                            <option value="all" <?php if ($get_dsn == 'all') echo 'selected'; ?>>Semua Dosen</option>
                                            <?php foreach ($dosen as $dsn): ?>
                                                <option value="<?php echo $dsn->id; ?>" <?php if ($dsn->id == $get_dsn) echo 'selected'; ?>><?php echo $dsn->nama_dosen; ?><?php if ($dsn->status == 0) echo ' - TIDAK AKTIF'; ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                                    <div class="col-md-6 form-group">
                                        <label for="category">Kategori</label>
                                        <select class="form-control" id="kategori" name="kategori" onchange="get_subkat()">
                                            <option value="all" <?php if ($get_kat == 'all') echo 'selected'; ?>>Semua Kategori</option>
                                            <?php foreach ($kategori as $kat): ?>
                                                <option value="<?php echo $kat->id; ?>" <?php if ($kat->id == $get_kat) echo 'selected'; ?>><?php echo $kat->nama_katbkd; ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                                    <div class="col-md-6 form-group">
                                        ...
                                        <select class="form-control" id="subkategori" name="subkategori">
                                            <option value="all" <?php if ($get_subkat == 'all') echo 'selected'; ?>>Semua Subkategori</option>
                                            <?php foreach ($subkategori as $subkat): ?>
                                                <option value="<?php echo $subkat->id; ?>" <?php if ($subkat->id == $get_subkat) echo 'selected'; ?>><?php echo $subkat->nama_subkatbkd; ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">BKD Data | 
                                <a href="<?php echo site_url('adminnya/bkd/tambah/'); ?>" type="button" class="btn btn-sm btn-primary text-right">Tambah BKD</a>
                                </h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                ...
                                <table id="bkdTable" class="table table-bordered table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <!-- Edit Button -->
                                            <a href="<?php echo site_url('adminnya/bkd/edit/' . $item->id); ?>" class="btn btn-block btn-warning btn-sm">
                                                <i class="fas fa-pencil-alt"></i>
                                            </a>
                                            
                                            <!-- Delete Button -->
                                            <a href="<?php echo site_url('adminnya/bkd/delete/' . $item->id); ?>" class="btn btn-block btn-danger btn-sm" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?')">
